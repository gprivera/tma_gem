...
<?php echo $this->Form->create('StudentPrerequisite'); ?>
	<fieldset>
		<legend><?php echo __('Edit Student Prerequisite'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StudentPrerequisite.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('StudentPrerequisite.id'))); ?></li>
