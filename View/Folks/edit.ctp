...
<?php echo $this->Form->create('Folk'); ?>
	<fieldset>
		<legend><?php echo __('Edit Folk'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Folk.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Folk.id'))); ?></li>
