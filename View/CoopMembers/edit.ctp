...
<?php echo $this->Form->create('CoopMember'); ?>
	<fieldset>
		<legend><?php echo __('Edit Coop Member'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CoopMember.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CoopMember.id'))); ?></li>
