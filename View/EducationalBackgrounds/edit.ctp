...
<?php echo $this->Form->create('EducationalBackground'); ?>
	<fieldset>
		<legend><?php echo __('Edit Educational Background'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EducationalBackground.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EducationalBackground.id'))); ?></li>
